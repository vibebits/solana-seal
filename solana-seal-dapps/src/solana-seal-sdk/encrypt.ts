...
import type { IBEEncryptions } from './bcs';
...
import type { KeyServer } from './key-server';
...
export async function encrypt({
	...
	console.log("isValidSuiObjectId", isValidSuiObjectId(packageId));
	// Check inputs
	if (
